...
import com.haru.generator.StaticGenerator;
import java.io.File;
...
public class MainGenerator {
    public static void main(String[] args) throws TemplateException, IOException {
        ...
        dataModel.setAuthor("Haru");
        dataModel.setLoop(true);
        dataModel.setOutputText("动态生成成功啦");
    ...
    public static void doGenerate(Object dataModel) throws TemplateException, IOException {
        ...
        //将haru-generator-basic项目的根路径作为输出路径
